...
var backmenu=new Bg(0,0,960,600,"img/MenuBackground.jpg",true);
var backtutorial=new Bg(0,0,960,600,"img/MenuInstrucoes.jpg",true);
var backdroundover = new Bg(0, 0, 1200, 600, "img/GameOverBg.jpg",true);
var backgame=new Bg(0,0,960,600,"img/FundoMarBack.jpg",true);
var backgame1=new Bg(0,0,960,600,"img/FundoMarBack.jpg",true);
